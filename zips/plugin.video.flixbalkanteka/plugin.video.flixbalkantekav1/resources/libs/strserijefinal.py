...
BASE_URL = "plugin://plugin.video.balkanteka/?action=strserijefinal"
HANDLE = int(sys.argv[1])
JSON_URL = 'https://raw.githubusercontent.com/BalkanDzo/balkandzo.github.io/refs/heads/main/fm/strserijefinal'
